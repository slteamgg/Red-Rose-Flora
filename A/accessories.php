...
if(isset($_GET['ItmId']))
{
	...
	{	
		...
		else
		{
			...
			//echo "<script> alert('Sucesssfully added to the the cart')</script>";
			}
...
else
{
	...
	//echo "<script> alert('Successfully added to the the cart')</script>";
	//print_r($_SESSION['cart']);
}
...
a.cardbutton1:hover , .Subbutton:hover
{
